/**
 * Sitemap Otaku World Site
 * ---------------------------------------------------
 * Otaku World Site
 * URL: https://www.otakuworld.site/
 * ---------------------------------------------------
 */
...
var toc_config = {
	...
	showNew: 15,
	newText: ' <strong style="font-weight:normal;font-style:normal;color:#fff;font-size:11px;background:#2942ee;padding:1px 6px 3px 6px;line-height:normal;float:right;border-radius:3px;">baru</strong>',
	sortAlphabetically: {
		thePanel: true,
		theList: true
	},
